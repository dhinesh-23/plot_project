...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-8 m-20">
            <div className="glass-card w-full max-w-md p-8">
                ...
                {error && (
                    <div className="bg-red-50 border border-red-200 text-red-700 p-3 rounded-xl mb-6">
                        {error}
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg transition transform hover:scale-105 disabled:opacity-50 mt-6"
                    >
